    ...
    <div class="header">
      <div style="display:flex;align-items:center">
        ...
        <el-select placeholder="请选择" v-model="selectValue" size="mini" @change="changetypes">
          <el-option label="总量" value="sale"></el-option>
          <el-option label="口罩数量" value="income"></el-option>
          <el-option label="非口罩数量" value="orders"></el-option>
